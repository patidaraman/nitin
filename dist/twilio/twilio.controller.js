...
var TwilioController_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.TwilioController = void 0;
const common_1 = require("@nestjs/common");
const twilio_service_1 = require("./twilio.service");
const twilio_dto_1 = require("./dto/twilio.dto");
let TwilioController = TwilioController_1 = class TwilioController {
    constructor(twilioService) {
        this.twilioService = twilioService;
        this.logger = new common_1.Logger(TwilioController_1.name);
    }
    async initiateCall(callData) {
        this.logger.log(`Received call initiation request from: ${callData.from} to: ${callData.to}`);
    ...
    async sendSms(smsData) {
        this.logger.log(`Received SMS request from: ${smsData.from} to: ${smsData.to}`);
        return this.twilioService.sendSms(smsData);
    }
    async getSmsStatus(messageSid) {
        this.logger.log(`Received SMS status request for MessageSid: ${messageSid}`);
        return this.twilioService.getSmsStatus(messageSid);
    }
    async sendWhatsApp(whatsAppData) {
        this.logger.log(`Received WhatsApp request from: ${whatsAppData.from} to: ${whatsAppData.to}`);
        return this.twilioService.sendWhatsApp(whatsAppData);
    }
    async sendBulkWhatsApp(bulkData) {
        this.logger.log(`Received bulk WhatsApp request for ${bulkData.phoneNumbers.length} numbers`);
        return this.twilioService.sendBulkWhatsApp(bulkData);
    }
    async sendEmail(emailData) {
        this.logger.log(`Received email request from: ${emailData.from} to: ${emailData.to}`);
    ...
    async getAvailableNumbers(countryCode) {
        this.logger.log(`Received available numbers request for country: ${countryCode}`);
...
<Response>
  ...
  <Redirect>/twilio/voice-response</Redirect>
    ...
    handleRecordingComplete(body, res) {
        try {
...
<Response>
  <Message>Thank you for your message!</Message>
    ...
    async handleIncomingWhatsApp(body, res) {
    ...
    generateChatbotResponse(message, from) {
        const phoneNumber = from.replace('whatsapp:', '');
        if (message.includes('visited your website') ||
...
__decorate([
    ...
    __metadata("design:paramtypes", [twilio_dto_1.InitiateCallDto]),
    __metadata("design:returntype", Promise)
], TwilioController.prototype, "initiateCall", null);
__decorate([
    (0, common_1.Get)('call-status/:callSid'),
    __param(0, (0, common_1.Param)('callSid')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], TwilioController.prototype, "getCallStatus", null);
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [twilio_dto_1.SendSmsDto]),
    __metadata("design:returntype", Promise)
], TwilioController.prototype, "sendSms", null);
__decorate([
    (0, common_1.Get)('sms-status/:messageSid'),
    __param(0, (0, common_1.Param)('messageSid')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], TwilioController.prototype, "getSmsStatus", null);
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [twilio_dto_1.SendWhatsAppDto]),
    __metadata("design:returntype", Promise)
], TwilioController.prototype, "sendWhatsApp", null);
__decorate([
    (0, common_1.Post)('send-bulk-whatsapp'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_1.UsePipes)(new common_1.ValidationPipe({ transform: true, whitelist: true })),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [twilio_dto_1.BulkWhatsAppDto]),
    __metadata("design:returntype", Promise)
], TwilioController.prototype, "sendBulkWhatsApp", null);
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [twilio_dto_1.SendEmailDto]),
    __metadata("design:returntype", Promise)
], TwilioController.prototype, "sendEmail", null);
__decorate([
    (0, common_1.Get)('account-info'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], TwilioController.prototype, "getAccountInfo", null);
__decorate([
    (0, common_1.Get)('phone-numbers'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], TwilioController.prototype, "getPhoneNumbers", null);
__decorate([
    (0, common_1.Get)('available-numbers/:countryCode'),
    __param(0, (0, common_1.Param)('countryCode')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], TwilioController.prototype, "getAvailableNumbers", null);
__decorate([
    (0, common_1.Get)('trial-info'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], TwilioController.prototype, "getTrialInfo", null);
__decorate([
    (0, common_1.Post)('voice-response'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], TwilioController.prototype, "handleVoiceResponse", null);
__decorate([
    (0, common_1.Post)('gather-response'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], TwilioController.prototype, "handleGatherResponse", null);
__decorate([
    (0, common_1.Post)('recording-complete'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], TwilioController.prototype, "handleRecordingComplete", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], TwilioController.prototype, "handleCallStatus", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], TwilioController.prototype, "handleSmsStatus", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], TwilioController.prototype, "handleWhatsAppStatus", null);
__decorate([
    (0, common_1.Post)('incoming-sms'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], TwilioController.prototype, "handleIncomingSms", null);
__decorate([
    (0, common_1.Post)('incoming-whatsapp'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], TwilioController.prototype, "handleIncomingWhatsApp", null);
__decorate([
    (0, common_1.Get)('health'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Object)
], TwilioController.prototype, "healthCheck", null);
exports.TwilioController = TwilioController = TwilioController_1 = __decorate([
